...
class DLTVR1D:
    ...
    def __init__(self, x, u, hidden_layers=[20,20,20,20,20,20], alpha=0.1,loss='l1', log_file=None, penalty_order=2, use_LBFGS=False):
        """
    ...
    def train(self, nIter=50000,minibatch_size=100000,patience=100): 
        ...
        for it in range(nIter):
            ...
            for i in range(n_batches):
                ...
                tf_dict = {self.x_tf: self.x[start:end], self.u_tf:self.u[start:end]}
